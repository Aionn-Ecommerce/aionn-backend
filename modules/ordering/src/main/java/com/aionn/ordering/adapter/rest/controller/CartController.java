...
public class CartController {
    ...
    public ResponseEntity<ApiResponse<CartResult>> getMyCart(@CurrentUserId String userId) {
    ...
    public ResponseEntity<ApiResponse<CartResult>> removeItem(
            @CurrentUserId String userId,
            @PathVariable String skuId) {
        CartResult result = cartService.removeItem(new RemoveItemCommand(userId, skuId));
    ...
    public ResponseEntity<ApiResponse<CartResult>> clearCart(@CurrentUserId String userId) {
        CartResult result = cartService.clearCart(new ClearCartCommand(userId, "user-cleared"));
    ...
    public ResponseEntity<ApiResponse<CartResult>> removeVoucher(@CurrentUserId String userId) {
        CartResult result = cartService.removeVoucher(new RemoveVoucherCommand(userId));
