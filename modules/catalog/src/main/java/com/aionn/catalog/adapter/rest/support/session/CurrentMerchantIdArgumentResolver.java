 ...
 *
 * <p>
 * The merchantId itself is the Merchant aggregate id (ULID) — not the user
 * principal name. The frontend (Shopee-style shop selector) sends the chosen
 * merchant via header on every request.
 * </p>
 */
@Component
