 ...
 *
 * <p>
 * Mirrors the Catalog resolver. Inventory operations always need the real
 * Merchant aggregate id (ULID), not the user principal name.
 * </p>
 */
@Component("inventoryCurrentMerchantIdArgumentResolver")
...
public class CurrentMerchantIdArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(
        ...
        if (merchantId == null || merchantId.isBlank()) {
            throw new InventoryException(InventoryErrorCode.WAREHOUSE_FORBIDDEN,
