...
import com.aionn.notification.application.port.out.subscription.DeviceTokenRepositoryPort;
...
import com.aionn.notification.infrastructure.persistence.repository.DeviceTokenRepository;
...
public class DeviceTokenRepositoryPersistenceAdapter implements DeviceTokenRepositoryPort {

    private final DeviceTokenRepository jpa;
