package com.aionn.notification.infrastructure.persistence.adapter.provider;
...
import com.aionn.notification.infrastructure.persistence.repository.NotificationProviderJpaRepository;
...
public class NotificationProviderRepositoryAdapter implements NotificationProviderRepository {

    private final NotificationProviderJpaRepository jpa;
