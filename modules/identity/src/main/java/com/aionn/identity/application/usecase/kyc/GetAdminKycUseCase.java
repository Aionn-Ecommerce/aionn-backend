...
public class GetAdminKycUseCase implements GetAdminKycQueryPort {
    ...
    public KycResult execute(String kycId) {
        return kycResultMapper.toResult(kycService.adminGet(kycId));
    }
}
