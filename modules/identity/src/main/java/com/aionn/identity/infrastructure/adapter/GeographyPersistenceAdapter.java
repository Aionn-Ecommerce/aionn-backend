...
public class GeographyPersistenceAdapter implements GeographyPersistencePort {
    ...
    @Override
    @Cacheable(value = "geography", key = "'country:' + #code", unless = "#result == null || !#result.isPresent()")
    ...
    @Override
    @Cacheable(value = "geography", key = "'province:' + #code", unless = "#result == null || !#result.isPresent()")
    ...
    @Override
    @Cacheable(value = "geography", key = "'district:' + #code", unless = "#result == null || !#result.isPresent()")
    ...
    @Override
    @Cacheable(value = "geography", key = "'ward:' + #code", unless = "#result == null || !#result.isPresent()")
